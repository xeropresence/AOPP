...
//this sucks,varargs? Is there a better way to handle this?
...
{
	typedef int* (__cdecl* originalFunctionHeader)(int* a1, int* a2, char* a3, char* a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11, int a12, int a13);
	...
	const auto res = reinterpret_cast<originalFunctionHeader>(DialogConstructorHook->originalTramp)(a1, a2, title, text, a5, a6, a7, a8, a9, a10, a11, a12, a13);
	return res;
}
